...
int main() {
    ...
    */
    ...
    unsigned char* data = stbi_load("D:/Document/ImmerLernen/opengl/src/container.jpg", &width, &height, &nrChannels, 0);
    if (data) {
    ...
    data = stbi_load("D:/Document/ImmerLernen/opengl/src/awesomeface.png", &width, &height, &nrChannels, 0);
    if (data) {
